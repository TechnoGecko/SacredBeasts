...
using UnityEngine;
using Strings = Utilities.Strings;

namespace Utilities
{
    /// <summary>Applies some <see cref="Utilities.CameraShake"/> when taking damage.</summary>
    /// <remarks>
    ...
    public sealed class CameraShakeWhenHit : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            {
                Utilities.CameraShake.Instance.Magnitude += _BaseMagnitude + hit.damage * _ScalingMagnitude;
            };
        }
